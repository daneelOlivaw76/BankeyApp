...
//  Bankey
//
//  Created by Rui Reis on 03/10/2023.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page2 = OnboardingViewController(heroImageName: "world", titleText: "Move your money around the world quickly adn securely.")
